...
function SQLite3_BackupInit(DestDB: TSQLiteDB; DestName: PAnsiChar; SourceDB: TSQLiteDB; SourceName: PAnsiChar): TSQLiteBackup; cdecl; external SQLiteDLL name 'sqlite3_backup_init';
function SQLite3_BackupStep(Backup: TSQLiteBackup; nPage: integer): integer; cdecl; external SQLiteDLL name 'sqlite3_backup_step';
function SQLite3_BackupFinish(Backup: TSQLiteBackup): integer; cdecl; external SQLiteDLL name 'sqlite3_backup_finish';
